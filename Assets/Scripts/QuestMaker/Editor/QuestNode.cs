...
//using UnityEngine;
//using static QuestMaker.Editor.Nodes.QuestStepNode;
...
//        public const string PREREQUISITE_INPUT_OPTION = "PrerequisiteInputOption";
//        public const string PREREQUISITE_OUTPUT_OPTION = "PrerequisiteOutputOption";
...
//            //AreaFound
//        }
//        private Type PreqTypeFromEnum(PrerequisiteType t)
//        {
//            return t switch
//            {
//                PrerequisiteType.Level => typeof(LevelPrerequisite),
//                PrerequisiteType.Quest => typeof(QuestPrerequisite),
//                PrerequisiteType.ItemOwnership => typeof(ItemPrerequisite),
//                _ => null,
//            };
//        }
//        protected override void OnDefineOptions(IOptionDefinitionContext context)
...
//                .WithDefaultValue(PrerequisiteType.Level)
...
//            Type localtype = PreqTypeFromEnum(prereqType);

//            context.AddInputPort(PREREQUISITE_INPUT_OPTION)
//                .WithDisplayName(localtype.Name)
//                .WithDataType(localtype.GetDeclaredMember("type").GetType())
//                .WithDefaultValue(default)
//                .Build();

//            context.AddOutputPort(PREREQUISITE_OUTPUT_OPTION)
//                .WithDisplayName("Out")
//                .WithDataType(localtype)
//                .Build();
...
//            //            .WithDataType(PreqTypeFromEnum(PrerequisiteType.Level))
//            //            .WithDefaultValue(0)
...
//            //            .WithDataType(PreqTypeFromEnum(PrerequisiteType.Quest))
//            //            .WithDefaultValue(default)
//            //            .WithDisplayName("Quest ID")
//            //            .WithConnectorUI(PortConnectorUI.Circle)
//            //            .Build();
...
//            //        context.AddInputPort(ITEM_ID_INPUT)
//            //            .WithDataType(PreqTypeFromEnum(PrerequisiteType.ItemOwnership))
//            //            .WithDefaultValue(default)
//            //            .WithDisplayName("Item ID")
//            //            .WithConnectorUI(PortConnectorUI.Circle)
//            //            .Build();
...
//    public class QuestPrerequisitesBaseNode : QuestMakerNode
//    {
//        public const string PREREQUISITES_AMOUNT = "PrerequisitesAmount";
//        public const string OPTION_PREFIX = "Preq_";

//        protected override void OnDefineOptions(IOptionDefinitionContext context)
//        {
//            context.AddOption(PREREQUISITES_AMOUNT, typeof(int))
//                .WithDisplayName("Number of Prerequisites")
//                .WithDefaultValue(1)
//                .WithTooltip("The amount of prerequisites required")
//                .Delayed()
//                .Build();
//        }
...
//        {
//            base.OnDefinePorts(context);
//            INodeOption acqAmount = GetNodeOptionByName(PREREQUISITES_AMOUNT);
//            acqAmount.TryGetValue(out int amount);

//            if (amount <= 0) return;

//            for (int i = 0; i < amount; i++)
//            {
//                context.AddInputPort(OPTION_PREFIX + i + 1)
//                        .WithDataType(typeof(QuestAcquisitionPrerequisite))
//                        .WithDefaultValue(default)
//                        .WithDisplayName(OPTION_PREFIX + i + 1)
//                        .WithConnectorUI(PortConnectorUI.Circle)
//                        .Build();
//            }
//        }
...
//    public class ItemPrerequisiteNode : QuestMakerNode
//    {
//        public const string PREREQ_OUTPUT_PORT = "PrerequisiteOutput";
//        public const string PREREQ_OPTION = "PrerequisiteOption";

//        protected override void OnDefineOptions(IOptionDefinitionContext context)
//        {
//            context.AddOption(PREREQ_OPTION, typeof(Item))
//                .WithDefaultValue(default)
...
//        protected override void OnDefinePorts(IPortDefinitionContext context)
//        {
//            context.AddOutputPort(PREREQ_OUTPUT_PORT)
//                .WithDataType<ItemPrerequisite>()
//                .WithDisplayName("Prerequisite Item")
//                .Build();
//        }
//    }
