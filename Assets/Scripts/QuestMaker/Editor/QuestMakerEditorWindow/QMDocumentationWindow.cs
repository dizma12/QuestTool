            ...
            switch (currentSection)
            {
                ...
                case InfoSection.CreatingGraphs:
                    ...
                    GUILayout.Label(
                        ...
                        "Existing examples live in Assets/QuestGraphs/.",
                        body);
                ...
                case InfoSection.Compiling:
                    ...
                    GUILayout.Label(
                        "Assets/Resources/Quests/<QuestID>/<QuestID>.asset\n\n" +
                ...
                case InfoSection.SceneSetup:
                    ...
                    GUILayout.Space(4);
                    GUILayout.Label(
                        "The demo scene Assets/Scenes/SampleScene.unity has everything wired; use it as the reference. " +
                        "All required prefabs live under Assets/Prefabs/.",
                        body);
